...
const staticPages: Page[] = [
  {
    ...
    title_th: 'หน้าแรก',
    title_en: 'Home',
    description_th: 'พระสงฆ์ไทยกับการแพทย์ยุคใหม่: Multi-omics และการป้องกันโรค NCD',
    description_en: 'Thai Monks and Modern Medicine: Multi-omics and NCD Prevention',
    hero_title_th: 'พระสงฆ์ไทยกับการแพทย์ยุคใหม่',
    hero_subtitle_th: 'Multi-omics และการป้องกันโรค NCD',
    page_order: 1,
    is_published: true,
    created_at: now,
    updated_at: now,
